...
public class books {
    ...
    public  int compareBookObjects(book b1, book b2)
    {
        if (b1.bookName.equalsIgnoreCase(b2.bookName)){
            System.out.println("Boo of this Name Already Exists....");
            return 0;
        }
        if(b1.sNo == b2.sNo){
...
public void addBook(book b){
    ...
    if(count<50){
        ...
        System.out.println("Error : No Space to Add More Books....");
    }
}
...
public void searchBySno()
    ...
    if(flag == 0)
    System.out.println("No Books Available of Serial Number" + sNo +"Found");
...
public void searchByAuthorName()
{
    ...
    for(int i=0; i<count;i++){
        if(authorName.equalsIgnoreCase(
            theBooks[i].authorName)){ System.out.println(
                theBooks[i].sNo + "\t\t"
                + theBooks[i].bookName + "\t\t"
                + theBooks[i].authorName + "\t\t"
                + theBooks[i].bookQtyCopy + "\t\t"
